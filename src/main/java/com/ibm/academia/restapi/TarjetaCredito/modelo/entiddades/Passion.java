...
public class Passion implements Serializable{
	...
	public Passion(Long id, String nombrePasion, String nombreUsuario) {
		Id = id;
	...
	private static final long serialVersionUID = -8595416158593477675L;
